...
const SpecialAlloySheets = () => {
  ...
  const productData = {
    ...
    subtitle:
      "Premium Quality Super-Austenitic & High-Nickel Alloy Sheets – SMO 254 (6% Moly) for Maximum Pitting Resistance & Alloy 20 (Carpenter 20) for Exceptional Sulfuric Acid Resistance",

    technicalOverview: {
      title: "Special Alloy Sheets: Technical Overview",
      description:
        "SMO 254 and Alloy 20 sheets are engineered to fill the performance gap where standard stainless steels fail. These super-austenitic and high-nickel alloys provide localized corrosion resistance in environments involving high chlorides or aggressive sulfuric acid, ensuring structural integrity in mission-critical chemical and marine infrastructure.",
    },

    gradeBreakdown: [
      {
        title: "SMO 254 Sheets (6% Moly / UNS S31254)",
        description:
        ...
        items: [
          "Pitting Resistance: With a PREN (Pitting Resistance Equivalent Number) of ?42.5, these sheets offer resistance to pitting and crevice corrosion that far exceeds Grade 316L.",
      ...
      {
        title: "Alloy 20 Sheets (Carpenter 20 / UNS N08020)",
        description:
    ...
    keyFeatures: [
      ...
      "Surface finishes: 2B, BA, No.1, 8K Mirror, Hairline, Satin, Embossed, PVC Coated",
      "Value Added Services: Laser/Plasma/Waterjet Cutting, Bending, Forging, Annealing, Polishing",
      "Complies with SMO 254: ASTM A240 / SA240 | Alloy 20: ASTM B463 / SB463",
    ],
    ...
    stockAvailability: {
      hotRolledSheets: {
        ...
        items: [
          "SMO 254 Hot Rolled Sheets",
          "Alloy 20 Hot Rolled Sheets",
          "ASME SA240 / SB463 HR Stock",
        ],
      },
      coldRolledSheets: {
        ...
        items: [
          ...
          "Alloy 20 Cold Rolled Sheets",
          "ASME SA240 / SB463 CR Stock",
        ],
      },
    },

    specifications: {
      standards: "SMO 254: ASTM A240 / SA240 | Alloy 20: ASTM B463 / SB463",
      thicknessSize: "0.3 mm to 120 mm | Width to 3500mm | Length to 6000mm",
      surfaceFinish:
        "2B, BA, No.1, 8K Mirror, Hairline, Satin, Embossed, PVC Coated",
      valueAddedServices:
        "Laser/Plasma/Waterjet Cutting, Bending, Forging, Annealing, Polishing",
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <section className="mb-8">
              <SectionTitle>
                Stock Availability: SMO 254 & Alloy 20 Sheets
              </SectionTitle>
            ...
            <section className="mb-8">
              <SectionTitle>
                Technical Specifications: SMO 254 & Alloy 20 Sheets
              </SectionTitle>
...
export default SpecialAlloySheets;
