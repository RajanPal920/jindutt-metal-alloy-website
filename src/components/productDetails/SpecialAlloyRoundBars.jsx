...
const SpecialAlloyRoundBars = () => {
  ...
  const productData = {
    ...
    subtitle:
      "Premium Quality Super-Austenitic & High-Nickel Alloy Round Bars – SMO 254 (6% Moly) for Maximum Pitting Resistance & Alloy 20 (Carpenter 20) for Exceptional Sulfuric Acid Resistance",

    technicalOverview: {
      title: "Special Alloy Round Bars: Technical Overview",
      description:
        "SMO 254 and Alloy 20 round bars are engineered to fill the performance gap where standard stainless steels fail. These super-austenitic and high-nickel alloys provide localized corrosion resistance in environments involving high chlorides or aggressive sulfuric acid, ensuring structural integrity in mission-critical chemical and marine infrastructure.",
    },

    gradeBreakdown: [
      {
        title: "SMO 254 Round Bars (6% Moly / UNS S31254)",
        description:
          "SMO 254 is a high-end austenitic stainless steel with a high molybdenum and nitrogen content. It was specifically developed for use in halide-containing environments such as seawater, brackish water, and pulp mill bleach plants.",
        items: [
          "Pitting Resistance: With a PREN (Pitting Resistance Equivalent Number) of ?42.5, these bars offer resistance to pitting and crevice corrosion that far exceeds Grade 316L.",
      ...
      {
        title: "Alloy 20 Round Bars (Carpenter 20 / UNS N08020)",
        description:
    ...
    keyFeatures: [
      ...
      "Finishes: Bright, Black, Polished, Centreless Ground, Cold Drawn",
      "Lengths: 1 to 6 Meters",
      "Complies with ASTM A276, A479, B473, B462 / ASME SA276, SB473",
    ],
    ...
    stockAvailability: {
      roundBars: {
        title: "SMO 254 & Alloy 20 Round Bars",
        image: roundBarsImage,
        items: [
          "SMO 254 (6% Moly) Round Bars",
          "Alloy 20 Carpenter 20 Rods",
          "ASTM A276 SMO 254 Round Bars",
          "ASTM B473 Alloy 20 Rods",
          "High Moly Corrosion Resistant Rods",
        ],
      },
      hexBars: {
        title: "Hexagon Bars & Rods",
        image: hexBarsImage,
        items: [
          "Alloy 20 Hexagon Rod",
          "SMO 254 Hex Bar Stock",
          "ASTM B473 Alloy 20 Hex Bars",
          "ASME SA276 SMO 254 Hex Rod",
          "Precision Machined Hexagon Rods",
        ],
      },
      squareBars: {
        title: "Square Bars & Rods",
        image: squareBarsImage,
        items: [
          "SMO 254 Square Bars",
          "Alloy 20 Industrial Square Rods",
          "ASTM B473 Alloy 20 Square Bars",
          "SMO 254 Hot Rolled Square Bar",
          "ASME SA276 Special Alloy Squares",
        ],
      },
      flatBars: {
        title: "Special Alloy Flat Bars",
        image: flatBarsImage,
        items: [
          "Alloy 20 / SMO 254 Flat Bars",
          "ASTM B473 Alloy 20 Flat Stock",
          "SMO 254 High Performance Flats",
          "Custom Cut Special Alloy Flats",
          "Acid Resistant Flat Sections",
        ],
      },
      brightBars: {
        ...
        items: [
          "SMO 254 Bright Polished Bars",
          "Alloy 20 Cold Drawn Bright Rods",
          "Alloy 20 Ground Shafting Bars",
          "SMO 254 Export Grade Bright Bars",
          "High Finish Special Alloy Rods",
        ],
      },
      rectangleBars: {
        ...
        items: [
          "Alloy 20 Rectangular Bars",
          "SMO 254 Rectangular Sections",
          "ASTM B473 Special Alloy Billets",
          "Forged Alloy 20 Rectangle Bars",
          "ASME SB473 Rectangular Rod Stock",
        ],
      },
    },

    specifications: {
      standards: "ASTM A276, A479, B473, B462 / ASME SA276, SB473",
      sizeRange: "Round: 4mm-500mm | Hex: 18mm-57mm | Square: 18mm-47mm",
      finishLength:
        "Bright, Black, Polished, Centreless Ground, Cold Drawn | 1 to 6 Meters",
      availableForms:
    ...
    equivalentGrades: {
      ...
      rows: [
        ["SMO 254", "S31254", "1.4547", "6% Moly | 254 SMO"],
    ...
    mechanicalProperties: {
      ...
      rows: [
        ["SMO 254", "650 min", "300 min", "35% min", "8.00"],
        ["Alloy 20", "550 min", "240 min", "30% min", "8.05"],
      ],
    },
    ...
    specializedProducts: [
      "SMO 254 (6% Moly) Superior Corrosion Resistant Bar Dealer",
      "Alloy 20 / Carpenter 20 Sulphuric Acid Resistant Bars Exporter",
      "ASME SB473 Alloy 20 Round Bars at Best Price",
      "High Performance Special Alloys Supplier in India",
      "SMO 254 Precision Ground & Bright Bars",
      "Marine Grade Special Alloy Rods Stockist in Mumbai",
      "ASTM A276 SMO 254 Hex & Square Rods Stockist in India",
      "Alloy 20 Cold Drawn & Polished Bars Supplier",
      "SMO 254 Black & Bright Round Bars Manufacturer",
      "Specialized in Shailesh Pipe Fitting India Quality Standard",
    ],

    relatedSearches: [
      "Alloy 20 Bars at Best Price",
      "SMO 254 Round Bars In Pune",
      "ASTM B473 Alloy 20 Bars",
      "SMO 254 Bar Stock Range",
      "Cost Of Alloy 20 HR Bars Exporter",
      "SMO 254 Round Bars Latest Price",
      "Special Alloy Bars Price List In India",
      "Alloy 20 Round Bars Chemical Composition",
      "SMO 254 Round Bars Stockyards In India",
      "SMO 254 Round Bars Pdf",
      "Alloy 20 Round Bars In Mumbai",
      "Cost Of SMO 254 Round Bars",
      "Alloy 20 Equivalent Grades",
      "SMO 254 Round Bars Price In India",
      "Alloy 20 Forged Bars",
      "Price Of SMO 254 Round Bars",
      "Special Alloy Round Bars Specifications",
      "Alloy 20 Hot Rolled bars Supplier",
      "ASME SA276 SMO 254 Bars",
      "Alloy 20 Bars Supplier In Mumbai",
      "SMO 254 Round Bars Suppliers In Gujarat",
      "Special Alloy Cold Drawn Bars Price List",
      "Alloy 20 Alloy Round Bar",
      "SMO 254 Bars Catalogue",
      "Special Alloy Manufacturers",
      "Alloy 20 Threaded Bars",
      "SMO 254 Round Bars Supplier In India",
      "Alloy 20 Round Bars Price List in India",
      "SMO 254 Round Bars Dimensions",
      "Alloy 20 Rods Stockist In Mumbai",
      "Special Alloy Round Bars Stocks",
      "SMO 254 Round Bars Weight Calculator",
    ],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <section className="mb-8">
              <SectionTitle>
                Stock Availability of SMO 254 & Alloy 20 Round Bars
              </SectionTitle>
            ...
            <section className="mb-8">
              <SectionTitle>
                Technical Specifications: Special Alloy Round Bars
              </SectionTitle>
            ...
            <section className="mb-8">
              <SectionTitle>
                Size and Dimensions of Special Alloy Round Bars
              </SectionTitle>
              <Table
            ...
            {/* Weight Chart */}
            <section className="mb-8">
              <SectionTitle>Special Alloy Round Bars Weight Chart</SectionTitle>
              <Table
            ...
            <section className="mb-8">
              <SectionTitle>
                Specialized in SMO 254 & Alloy 20 Round Bars & Rods
              </SectionTitle>
            ...
            <section className="mb-8">
              <SectionTitle>
                Searches Related to Special Alloy Round Bars
              </SectionTitle>
...
export default SpecialAlloyRoundBars;
